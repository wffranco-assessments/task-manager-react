  ...
  return (
    <main className="flex flex-col flex-grow justify-between overflow-hidden">
      ...
      <div className="flex flex-col max-h-[60%] overflow-hidden">
        <header className="pb-6 -mb-3 bg-blue-700 rounded-t-xl text-white p-3">Tasks</header>
        <div className="overflow-hidden">
          {tasks?.length ? (
            <article className="bg-sky-500 rounded-t-xl p-3 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 max-h-full overflow-auto">
              {tasks.map((task) => (
                <div className="bg-white border rounded p-3 flex flex-col gap-4" key={task.id}>
                  ...
                  <div className="flex justify-between">
                    ...
                    <Button to={`/tasks/edit/${task.id}`} className="p-2">
            ...
            <article className="bg-sky-500 rounded-t-xl px-3 py-14 text-center">
